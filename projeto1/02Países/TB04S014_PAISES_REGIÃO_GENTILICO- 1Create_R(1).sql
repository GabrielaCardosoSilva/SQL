...
-- ----------------------------------------------------------------------------------------
-- CTB00001- GIS_TB04S014_PAISES_REGIÃO_GENTILICO
--
-- Criar esta tabela com as colunas:
--
-- cod_pais        numeric (3, 0)   Not Null PK CL  Código do País
-- região          char    (2)      Not Null PK CL  Sigla da Região
-- seq             num     (2, 0)   Not Null PK CL  Sequência
-- gentilico       varchar (45)     Not Null        Gentílico
-- obs             varchar (72)         Null        Comentário (Observação)
--
-- Atenção:
-- Declarar a Chave Primária (Primary Key, ou Identificador Único, ou apenas PK) através de
-- um constraint de nome PK_GIS_TB04S014_PAISES_REGIÃO_GENTILICO.
--
...
--
-- Definir  um  constraint  de  nome  CK_GIS_TB04S014_PAISES_REGIÃO_GENTILICO_COD_PAIS para
-- a coluna COD_PAIS, a qual deve admitir valores entre 1 e 260 (inclusive).
--
-- Definir um constraint  de nome FK_GIS_TB04S014_PAISES_REGIÃO_GENTILICO_COD_PAIS  para  a
...
If  exists 
 (Select *
   ...
   Where object_id  =  OBJECT_ID(N'dbo.CK_GIS_TB04S014_PAISES_REGIÃO_GENTILICO') 
     and parent_object_id = OBJECT_ID(N'dbo.GIS_TB04S014_PAISES_REGIÃO_GENTILICO'))
   ALTER TABLE  dbo.GIS_TB04S014_PAISES_REGIÃO_GENTILICO
      DROP CONSTRAINT CK_GIS_TB04S014_PAISES_REGIÃO_GENTILICO;
IF  EXISTS
  (select *
    From  sys.objects
    Where object_id = OBJECT_ID(N'dbo.GIS_TB04S014_PAISES_REGIÃO_GENTILICO') 
      and type in (N'U'))
   DROP TABLE dbo.GIS_TB04S014_PAISES_REGIÃO_GENTILICO;
--
-- ----------------------------------------------------------------------------------------
-- Criação da tabela.
-- ----------------------------------------------------------------------------------------
...
if exists
 (select *
   from dbo.sysobjects
   where id = object_id(N'dbo.GIS_TB04S014_PAISES_REGIÃO_GENTILICO')
   and OBJECTPROPERTY(id, N'IsUserTable') = 1)
DROP TABLE dbo.GIS_TB04S014_PAISES_REGIÃO_GENTILICO;
--
CREATE TABLE dbo.GIS_TB04S014_PAISES_REGIÃO_GENTILICO (
 cod_pais        numeric (3, 0)   Not Null ,
 região          char    (2)      Not Null ,
 seq             numeric (2, 0)   Not Null ,
 gentilico       varchar (45)     Not Null ,
 obs             varchar (72)         Null ,
  Constraint PK_GIS_TB04S014_PAISES_REGIÃO_GENTILICO Primary Key Clustered
   (cod_pais asc, região asc, seq asc)
   WITH
    FILLFACTOR = 10,
  Constraint CK_GIS_TB04S014_PAISES_REGIÃO_GENTILICO_cod_pais Check
   (cod_pais between 1 and 260),
  CONSTRAINT FK_GIS_TB04S014_PAISES_REGIÃO_GENTILICO_cod_pais FOREIGN KEY (cod_pais)
