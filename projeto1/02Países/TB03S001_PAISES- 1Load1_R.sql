...
Insert into dbo.GIS_TB03S001_PAISES values
  (8, 'Antilhas Holandesas', 'Antilhas Neerlandesas', 'AN', 'ANT', 'AHL', 599, 2, 22, 800, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
...
Insert into dbo.GIS_TB03S001_PAISES values
  (111, 'Kosovo', NULL, '', 'IUG', 'IUG', 420, 4, 40, 255804, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
...
Insert into dbo.GIS_TB03S001_PAISES values
  (203, 'Suazilândia', 'Reino de Essuatini', 'SZ', 'SWZ', 'SUA', 268, 1, 10, 17364, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
...
Insert into dbo.GIS_TB03S001_PAISES values
  (241, 'Abecásia', 'República da Abecásia', NULL, NULL, NULL, 940, 3, 32, 8432, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (242, 'Chipre do Norte', 'República Turca de Chipre do Norte', NULL, NULL, NULL, NULL, 3, 30, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (243, 'Bailiado de Jersey', NULL, NULL, NULL, NULL, NULL, 4, 40, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (244, 'Curaçao', NULL, NULL, NULL, NULL, NULL, 4, 40, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (245, 'Guemsey', NULL, NULL, NULL, NULL, NULL, 4, 40, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (246, 'Ilha de Man', NULL, NULL, NULL, NULL, NULL, 4, 40, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (247, 'Ilhas Christmas', NULL, NULL, NULL, NULL, NULL, 5, 50, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (248, 'Ilhas Cocos', NULL, NULL, NULL, NULL, NULL, 4, 40, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (249, 'Ilhas PitCairn (Picárnia)', NULL, NULL, NULL, NULL, NULL, 4, 40, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (250, 'Ossétia do Sul', NULL, NULL, NULL, NULL, NULL, 4, 40, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (251, 'Polinésia Francesa', NULL, NULL, NULL, NULL, NULL, 4, 40, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (252, 'Saint-Martin', NULL, NULL, NULL, NULL, NULL, 4, 40, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (253, 'São Bartolomeu', NULL, NULL, NULL, NULL, NULL, 4, 40, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (254, 'São Martinho', NULL, NULL, NULL, NULL, NULL, 4, 40, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (255, 'Transnitria (Transdnistria)', NULL, NULL, NULL, NULL, NULL, 4, 40, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (256, 'Fantasia', 'Fantasy', 'FT', 'FNT', 'FNT', 888, 8, 80, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (257, 'Longistão', 'Longistão', 'FT', 'FNT', 'FNT', 888, 8, 80, NULL, NULL);
Insert into dbo.GIS_TB03S001_PAISES values
  (258, 'Nihil', 'País não informado', 'NH', 'NHL', 'NHL', 888, 8, 80, NULL, NULL);
--
-- ----------------------------------------------------------------------------------------
