...
--
-- cod_pais        numeric (3, 0)   Not Null PK CL  Código País de localização
-- uf              char (3)         Not Null PK CL  UF no País de localização
-- seq_pais        numeric (3, 0)   Not Null PK CL  Sequência no País de localização
-- nome            varchar (72)         Null        Nome do vulcão
-- elevação        numeric (5, 0)       Null        Elevação (metros)
...
--
-- Definir um constraint de nome CK_GIS_TB06S006_UF_VULCOES_COD_PAIS para a coluna COD_PAIS,
-- a qual deve admitir valores entre 1 e 260 (inclusive).
--
-- Definir um constraint de nome CK_GIS_TB06S006_UF_VULCOES_SEQ_PAIS para a coluna SEQ_PAIS,
-- a qual deve admitir valores maiores do que 0.
--
-- Definir um constraint de nome FK_GIS_TB06S006_UF_VULCOES_PAIS  para as colunas  COD_PAIS
